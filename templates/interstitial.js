$def with (banner, banner_html, banner_zone)
...
// css.innerHTML += "#interContainer{position:absolute;width:670px;left:0;top:0;background-color:#d0e47e;border:1px solid #000;visibility:hidden;z-index:6;padding:0 15px 15px} #interContainer .headerbar{color:gray;text-align:right;padding:5px 0}#interContainer .headerbar a{font-size:120%;text-decoration:none}#interContent{border:1px solid gray;background-color:#FFF}#interVeil{position:absolute;background:#000 url(blackdot.gif);right:0;width:10px;top:0;z-index:5;visibility:hidden;filter:progid:DXImageTransform.Microsoft.alpha(opacity=80);opacity:0.8}";

OMAds = {}
OMAds.insert_banner = function(options) {


	var ad = $$('<div class="modal"><iframe width="800" height="600" scxrolling="no" frameborder="no" style="border:0;" src="http://ad.openmultimedia.biz/telesur/H/"></iframe><div id="simplemodal-caption">PUBLICIDAD</div></div>');
